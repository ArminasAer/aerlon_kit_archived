...
- navbar is now correctly handled
  - needs more condition styles for expanded and scrolled states though
- more adjustments to bring svelte built up to rust build

## [0.6.0] - 2023-07-22

#### Changed

- lots of design changes with new theming for 'Aerlon'
  - lots more to port over from the Rust build
